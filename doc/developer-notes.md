...
FunByte Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as FunByte Core, where everyone uses
...
pay attention to for reviewers of FunByte Core code.

General FunByte Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: FunByte Core uses tinyformat, which is type safe. Leave them out to avoid confusion
