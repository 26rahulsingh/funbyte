...
Only requiring some minor changes is funbyte.cpp.
...
Changes to funbyte.cpp
----------------------
funbyte.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
