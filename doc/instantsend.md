...
This mechanism has been integrated into Bitcore-Node-FunByte which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/funbytecoin/insight-api-funbyte#web-socket-api](https://github.com/funbytecoin/insight-api-funbyte#web-socket-api) 
* API: [https://github.com/funbytecoin/insight-api-funbyte#instantsend-transactions](https://github.com/funbytecoin/insight-api-funbyte#instantsend-transactions) 
...
By default, the FunByte Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the FunByte Core daemon:
