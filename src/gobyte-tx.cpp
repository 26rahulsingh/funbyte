...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("FunByte Core funbyte-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  funbyte-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded funbyte transaction") + "\n" +
              "  funbyte-tx [options] -create [commands]   " + _("Create hex-encoded funbyte transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded funbyte transaction
