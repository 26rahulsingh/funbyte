...
2. run funbyted with -printalert or -sendalert like this:
   /path/to/funbyted -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.funbyte.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/FunByte Core:0.12.0.58/"));
