    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("FunByte Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About FunByte Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  funbyte-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the FunByte in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 FBX, 0.1 FBX, 1 FBX and 10 FBX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://funbytecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://funbytecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("FunByte Core is shutting down...") + "<br /><br />" +
