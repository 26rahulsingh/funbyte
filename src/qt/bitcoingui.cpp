    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("FunByte Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a FunByte address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and funbyte: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About FunByte Core"), this);
    aboutAction->setStatusTip(tr("Show information about FunByte Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for FunByte Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your FunByte addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified FunByte addresses"));
    ...
    openAction->setStatusTip(tr("Open a funbyte: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the FunByte Core help message to get a list with possible FunByte Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("FunByte Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to FunByte network", "", count));
}
...
{
    QString strTitle = tr("FunByte Core"); // default title
