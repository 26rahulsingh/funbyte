    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("FBX-light"), QVariant("light"));
    ui->theme->addItem(QString("FBX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("FBX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("FBX-traditional"), QVariant("trad"));
