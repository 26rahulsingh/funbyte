...
{
    if(fLiteMode) return; // ignore all FunByte related functionality
...
/*
    ...
    allow endless transaction that would bloat FunByte and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("funbyte-privatesend");
