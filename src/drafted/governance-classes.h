 ...
 *
 *   // network
 *   CFunByteNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.funbyte.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CFunByteNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CFunByteNetwork(UniValue objIn)
    {
...
// // can be under: FunByteNetwork
// //   -- signature requirements : Key1(User)
// class CFunByteNetworkVariable : public CGovernanceObject
// {
// private:
