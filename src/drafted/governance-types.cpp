...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "FunByteNetwork") type = FunByteNetwork;
    if(strType == "FunByteNetworkVariable") type = FunByteNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == FunByteNetwork) s = "FunByteNetwork";
    if(type == FunByteNetworkVariable) s = "FunByteNetworkVariable";
